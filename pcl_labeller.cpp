  ...
  ui (new Ui::PCL_Labeller)
{
  ...
  ui->qt_pcl_Visualizer->SetRenderWindow (viewer->getRenderWindow ());
  viewer->setupInteractor (ui->qt_pcl_Visualizer->GetInteractor (), ui->qt_pcl_Visualizer->GetRenderWindow ());
  ui->qt_pcl_Visualizer->update ();
  viewer->addCoordinateSystem (1.0);
  viewer->setCameraPosition(10, 0, 10, 0, 0, 1);
  ui->qt_pcl_Visualizer->GetRenderWindow()->Render();
